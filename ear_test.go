...
func TestVerify_fail(t *testing.T) {
	tvs := []struct {
		...
		},
		{
			...
			expected: ` jwt.Parse: failed to parse token: jws.Verify: protected header "alg" "none" does not match caller-supplied algorithm "ES256"`,
		},
		{
			// bad JWT formatting
